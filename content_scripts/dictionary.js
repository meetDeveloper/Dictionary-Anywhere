...
function createDiv(info) {
    ...
    if(LANGUAGE == "ro") {
        moreInfo.href = `https://dexonline.ro/definitie/${info.word}`;
    } else {
        moreInfo.href = makeLink(info.word, LANGUAGE);
    }
...
function updateLanguageAndTriggerKey() {
